...
| 27 | **Remaining gaps** | ⏳ Open | monaco-editor 0.55.1 still bundles DOMPurify 3.2.7 internally (needs an upstream monaco release). Pricing has no billing (copy says "free during beta"). |
